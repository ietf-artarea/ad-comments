...
If these characters are possible to encounter, they ought to be allowed in the specification, and recognized, if you are trying to specify a transformation here, give a name to each side of the transformation and describe how to handle any exceptions that might be encountered from malformed data.
...
Is it possible that adding such a limit could lead to other application failure issues?
