...
TEMPLATE_FILE="templates/ad-evaluation-$AUTHOR_NAME.md"
TARGET_DIR="ad-evaluation/$DRAFT_VERSION"
TARGET_FILE="$TARGET_DIR/ad-evaluation-$AUTHOR_NAME.md"
